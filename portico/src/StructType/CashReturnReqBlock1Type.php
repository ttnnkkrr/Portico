...
/**
 * This class stands for CashReturnReqBlock1Type StructType
 * @subpackage Structs
 */
class CashReturnReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    /**
     * Constructor method for CashReturnReqBlock1Type
     * @uses CashReturnReqBlock1Type::setAmt()
     * @uses CashReturnReqBlock1Type::setGatewayTxnId()
     * @uses CashReturnReqBlock1Type::setCardHolderData()
     * @uses CashReturnReqBlock1Type::setAdditionalTxnFields()
     * @param float $amt
     ...
     */
    public function __construct($amt = null, $gatewayTxnId = null, \StructType\CardHolderDataType $cardHolderData = null, \StructType\AdditionalTxnFieldsType $additionalTxnFields = null)
    {
        $this
            ->setAmt($amt)
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\CashReturnReqBlock1Type
     */
