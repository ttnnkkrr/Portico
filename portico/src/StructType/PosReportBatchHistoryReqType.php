...
/**
 * This class stands for PosReportBatchHistoryReqType StructType
 * @subpackage Structs
 */
class PosReportBatchHistoryReqType extends AbstractStructBase
{
    /**
     * The RptStartUtcDT
    ...
    public $TzConversion;
    /**
     * Constructor method for PosReportBatchHistoryReqType
     * @uses PosReportBatchHistoryReqType::setRptStartUtcDT()
     * @uses PosReportBatchHistoryReqType::setRptEndUtcDT()
     * @uses PosReportBatchHistoryReqType::setDeviceId()
     * @uses PosReportBatchHistoryReqType::setTzConversion()
     ...
     * @param string $rptStartUtcDT
     * @return \StructType\PosReportBatchHistoryReqType
     */
