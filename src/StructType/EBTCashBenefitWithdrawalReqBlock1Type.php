...
/**
 * This class stands for EBTCashBenefitWithdrawalReqBlock1Type StructType
 * @subpackage Structs
 */
class EBTCashBenefitWithdrawalReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    public $AllowDup;
    /**
     * Constructor method for EBTCashBenefitWithdrawalReqBlock1Type
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setAmt()
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setCashBackAmount()
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setCardData()
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setPinBlock()
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setCardHolderData()
     * @uses EBTCashBenefitWithdrawalReqBlock1Type::setAllowDup()
     * @param float $amt
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\EBTCashBenefitWithdrawalReqBlock1Type
     */
