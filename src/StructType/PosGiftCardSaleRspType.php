...
/**
 * This class stands for PosGiftCardSaleRspType StructType
 * @subpackage Structs
 */
class PosGiftCardSaleRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $BalanceAmt;
    /**
     * The SplitTenderCardAmt
     * Meta informations extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var float
     */
    public $SplitTenderCardAmt;
    /**
     * The SplitTenderBalanceDueAmt
     * Meta informations extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var float
    ...
    public $Notes;
    /**
     * Constructor method for PosGiftCardSaleRspType
     * @uses PosGiftCardSaleRspType::setRspCode()
     * @uses PosGiftCardSaleRspType::setRspText()
     * @uses PosGiftCardSaleRspType::setAuthCode()
     * @uses PosGiftCardSaleRspType::setBalanceAmt()
     * @uses PosGiftCardSaleRspType::setSplitTenderCardAmt()
     * @uses PosGiftCardSaleRspType::setSplitTenderBalanceDueAmt()
     * @uses PosGiftCardSaleRspType::setPointsBalanceAmt()
     * @uses PosGiftCardSaleRspType::setRewards()
     * @uses PosGiftCardSaleRspType::setNotes()
     * @param int $rspCode
     * @param string $rspText
     * @param string $authCode
     * @param float $balanceAmt
     * @param float $splitTenderCardAmt
     * @param float $splitTenderBalanceDueAmt
     * @param float $pointsBalanceAmt
     * @param string $rewards
     * @param string $notes
     */
    public function __construct($rspCode = null, $rspText = null, $authCode = null, $balanceAmt = null, $splitTenderCardAmt = null, $splitTenderBalanceDueAmt = null, $pointsBalanceAmt = null, $rewards = null, $notes = null)
    {
        $this
            ->setRspCode($rspCode)
            ->setRspText($rspText)
            ...
            ->setSplitTenderCardAmt($splitTenderCardAmt)
            ->setSplitTenderBalanceDueAmt($splitTenderBalanceDueAmt)
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosGiftCardSaleRspType
     */
    ...
    /**
     * Get SplitTenderCardAmt value
     * @return float|null
     */
    public function getSplitTenderCardAmt()
    {
        return $this->SplitTenderCardAmt;
    }
    /**
     * Set SplitTenderCardAmt value
     * @param float $splitTenderCardAmt
     * @return \StructType\PosGiftCardSaleRspType
     */
    public function setSplitTenderCardAmt($splitTenderCardAmt = null)
    {
        $this->SplitTenderCardAmt = $splitTenderCardAmt;
        return $this;
    }
    /**
     * Get SplitTenderBalanceDueAmt value
     * @return float|null
     */
    public function getSplitTenderBalanceDueAmt()
    {
        return $this->SplitTenderBalanceDueAmt;
    }
    /**
     * Set SplitTenderBalanceDueAmt value
     * @param float $splitTenderBalanceDueAmt
     * @return \StructType\PosGiftCardSaleRspType
     */
    public function setSplitTenderBalanceDueAmt($splitTenderBalanceDueAmt = null)
    {
