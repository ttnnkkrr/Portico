...
/**
 * This class stands for PosAltPayVoidReqType StructType
 * @subpackage Structs
 */
class PosAltPayVoidReqType extends AbstractStructBase
{
    /**
     * The TransactionType
    ...
    public $GatewayTxnId;
    /**
     * Constructor method for PosAltPayVoidReqType
     * @uses PosAltPayVoidReqType::setTransactionType()
     * @uses PosAltPayVoidReqType::setGatewayTxnId()
     ...
     * @param string $transactionType
     * @return \StructType\PosAltPayVoidReqType
     */
