...
/**
 * This class stands for PosGiftCardBalanceRspType StructType
 * @subpackage Structs
 */
class PosGiftCardBalanceRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Notes;
    /**
     * Constructor method for PosGiftCardBalanceRspType
     * @uses PosGiftCardBalanceRspType::setRspCode()
     * @uses PosGiftCardBalanceRspType::setRspText()
     * @uses PosGiftCardBalanceRspType::setAuthCode()
     * @uses PosGiftCardBalanceRspType::setBalanceAmt()
     * @uses PosGiftCardBalanceRspType::setPointsBalanceAmt()
     * @uses PosGiftCardBalanceRspType::setRewards()
     * @uses PosGiftCardBalanceRspType::setNotes()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosGiftCardBalanceRspType
     */
