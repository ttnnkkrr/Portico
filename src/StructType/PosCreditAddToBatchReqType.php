...
/**
 * This class stands for PosCreditAddToBatchReqType StructType
 * @subpackage Structs
 */
class PosCreditAddToBatchReqType extends AbstractStructBase
{
    /**
     * The GatewayTxnId
    ...
    public $TagData;
    /**
     * Constructor method for PosCreditAddToBatchReqType
     * @uses PosCreditAddToBatchReqType::setGatewayTxnId()
     * @uses PosCreditAddToBatchReqType::setAmt()
     * @uses PosCreditAddToBatchReqType::setGratuityAmtInfo()
     * @uses PosCreditAddToBatchReqType::setLodgingDataEdit()
     * @uses PosCreditAddToBatchReqType::setDirectMktData()
     * @uses PosCreditAddToBatchReqType::setSurchargeAmtInfo()
     * @uses PosCreditAddToBatchReqType::setEMVTagData()
     * @uses PosCreditAddToBatchReqType::setTagData()
     ...
     * @param int $gatewayTxnId
     * @return \StructType\PosCreditAddToBatchReqType
     */
