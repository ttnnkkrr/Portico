...
/**
 * This class stands for PosAltPayCaptureRspType StructType
 * @subpackage Structs
 */
class PosAltPayCaptureRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPayCaptureRspType
     * @uses PosAltPayCaptureRspType::setRspCode()
     * @uses PosAltPayCaptureRspType::setRspMessage()
     * @uses PosAltPayCaptureRspType::setStatus()
     * @uses PosAltPayCaptureRspType::setStatusMessage()
     * @uses PosAltPayCaptureRspType::setProcessor()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPayCaptureRspType
     */
