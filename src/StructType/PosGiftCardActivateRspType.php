...
/**
 * This class stands for PosGiftCardActivateRspType StructType
 * @subpackage Structs
 */
class PosGiftCardActivateRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Notes;
    /**
     * Constructor method for PosGiftCardActivateRspType
     * @uses PosGiftCardActivateRspType::setRspCode()
     * @uses PosGiftCardActivateRspType::setRspText()
     * @uses PosGiftCardActivateRspType::setAuthCode()
     * @uses PosGiftCardActivateRspType::setBalanceAmt()
     * @uses PosGiftCardActivateRspType::setPointsBalanceAmt()
     * @uses PosGiftCardActivateRspType::setRewards()
     * @uses PosGiftCardActivateRspType::setNotes()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosGiftCardActivateRspType
     */
