...
/**
 * This class stands for PosGiftCardRewardRspType StructType
 * @subpackage Structs
 */
class PosGiftCardRewardRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Notes;
    /**
     * Constructor method for PosGiftCardRewardRspType
     * @uses PosGiftCardRewardRspType::setRspCode()
     * @uses PosGiftCardRewardRspType::setRspText()
     * @uses PosGiftCardRewardRspType::setAuthCode()
     * @uses PosGiftCardRewardRspType::setBalanceAmt()
     * @uses PosGiftCardRewardRspType::setPointsBalanceAmt()
     * @uses PosGiftCardRewardRspType::setRewards()
     * @uses PosGiftCardRewardRspType::setNotes()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosGiftCardRewardRspType
     */
