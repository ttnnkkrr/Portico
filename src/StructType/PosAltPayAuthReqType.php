...
/**
 * This class stands for PosAltPayAuthReqType StructType
 * @subpackage Structs
 */
class PosAltPayAuthReqType extends AbstractStructBase
{
    /**
     * The TransactionType
    ...
    public $LineItem;
    /**
     * Constructor method for PosAltPayAuthReqType
     * @uses PosAltPayAuthReqType::setTransactionType()
     * @uses PosAltPayAuthReqType::setSessionId()
     * @uses PosAltPayAuthReqType::setBuyer()
     * @uses PosAltPayAuthReqType::setAmt()
     * @uses PosAltPayAuthReqType::setShipping()
     * @uses PosAltPayAuthReqType::setPayment()
     * @uses PosAltPayAuthReqType::setLineItem()
     ...
     * @param string $transactionType
     * @return \StructType\PosAltPayAuthReqType
     */
