...
/**
 * This class stands for DebitReturnReqBlock1Type StructType
 * @subpackage Structs
 */
class DebitReturnReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    /**
     * Constructor method for DebitReturnReqBlock1Type
     * @uses DebitReturnReqBlock1Type::setAmt()
     * @uses DebitReturnReqBlock1Type::setGatewayTxnId()
     * @uses DebitReturnReqBlock1Type::setTrackData()
     * @uses DebitReturnReqBlock1Type::setPinBlock()
     * @uses DebitReturnReqBlock1Type::setTokenValue()
     * @uses DebitReturnReqBlock1Type::setCardHolderData()
     * @uses DebitReturnReqBlock1Type::setAllowDup()
     * @uses DebitReturnReqBlock1Type::setEncryptionData()
     * @uses DebitReturnReqBlock1Type::setAdditionalTxnFields()
     * @param float $amt
     ...
     */
    public function __construct($amt = null, $gatewayTxnId = null, $trackData = null, $pinBlock = null, $tokenValue = null, \StructType\CardHolderDataType $cardHolderData = null, $allowDup = null, \StructType\EncryptionDataType $encryptionData = null, \StructType\AdditionalTxnFieldsType $additionalTxnFields = null)
    {
        $this
            ->setAmt($amt)
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\DebitReturnReqBlock1Type
     */
