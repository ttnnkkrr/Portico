...
/**
 * This class stands for PosAltPayCreateAuthRspType StructType
 * @subpackage Structs
 */
class PosAltPayCreateAuthRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPayCreateAuthRspType
     * @uses PosAltPayCreateAuthRspType::setRspCode()
     * @uses PosAltPayCreateAuthRspType::setRspMessage()
     * @uses PosAltPayCreateAuthRspType::setStatus()
     * @uses PosAltPayCreateAuthRspType::setStatusMessage()
     * @uses PosAltPayCreateAuthRspType::setProcessor()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPayCreateAuthRspType
     */
