...
/**
 * This class stands for CreditOfflineSaleReqBlock1Type StructType
 * @subpackage Structs
 */
class CreditOfflineSaleReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    public $TagData;
    /**
     * Constructor method for CreditOfflineSaleReqBlock1Type
     * @uses CreditOfflineSaleReqBlock1Type::setAmt()
     * @uses CreditOfflineSaleReqBlock1Type::setCardData()
     * @uses CreditOfflineSaleReqBlock1Type::setGratuityAmtInfo()
     * @uses CreditOfflineSaleReqBlock1Type::setCPCReq()
     * @uses CreditOfflineSaleReqBlock1Type::setOfflineAuthCode()
     * @uses CreditOfflineSaleReqBlock1Type::setCardHolderData()
     * @uses CreditOfflineSaleReqBlock1Type::setDirectMktData()
     * @uses CreditOfflineSaleReqBlock1Type::setAllowDup()
     * @uses CreditOfflineSaleReqBlock1Type::setLodgingData()
     * @uses CreditOfflineSaleReqBlock1Type::setAutoSubstantiation()
     * @uses CreditOfflineSaleReqBlock1Type::setAdditionalTxnFields()
     * @uses CreditOfflineSaleReqBlock1Type::setEcommerce()
     * @uses CreditOfflineSaleReqBlock1Type::setConvenienceAmtInfo()
     * @uses CreditOfflineSaleReqBlock1Type::setShippingAmtInfo()
     * @uses CreditOfflineSaleReqBlock1Type::setSurchargeAmtInfo()
     * @uses CreditOfflineSaleReqBlock1Type::setEMVTagData()
     * @uses CreditOfflineSaleReqBlock1Type::setTagData()
     * @param float $amt
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\CreditOfflineSaleReqBlock1Type
     */
