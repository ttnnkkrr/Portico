...
/**
 * This class stands for PosAltPayVoidRspType StructType
 * @subpackage Structs
 */
class PosAltPayVoidRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPayVoidRspType
     * @uses PosAltPayVoidRspType::setRspCode()
     * @uses PosAltPayVoidRspType::setRspMessage()
     * @uses PosAltPayVoidRspType::setStatus()
     * @uses PosAltPayVoidRspType::setStatusMessage()
     * @uses PosAltPayVoidRspType::setProcessor()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPayVoidRspType
     */
