...
/**
 * This class stands for PosCheckSaleRspType StructType
 * @subpackage Structs
 */
class PosCheckSaleRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $CheckRspInfo;
    /**
     * Constructor method for PosCheckSaleRspType
     * @uses PosCheckSaleRspType::setRspCode()
     * @uses PosCheckSaleRspType::setRspMessage()
     * @uses PosCheckSaleRspType::setAuthCode()
     * @uses PosCheckSaleRspType::setAdditionalTxnFields()
     * @uses PosCheckSaleRspType::setCheckRspInfo()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosCheckSaleRspType
     */
    ...
    {
        foreach ($checkRspInfo as $posCheckSaleRspTypeCheckRspInfoItem) {
            // validation for constraint: itemType
            if (!$posCheckSaleRspTypeCheckRspInfoItem instanceof \StructType\CheckRspInfoType) {
                throw new \InvalidArgumentException(sprintf('The CheckRspInfo property can only contain items of \StructType\CheckRspInfoType, "%s" given', is_object($posCheckSaleRspTypeCheckRspInfoItem) ? get_class($posCheckSaleRspTypeCheckRspInfoItem) : gettype($posCheckSaleRspTypeCheckRspInfoItem)), __LINE__);
            }
        }
