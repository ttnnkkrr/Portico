...
/**
 * This class stands for EBTFSPurchaseReqBlock1Type StructType
 * @subpackage Structs
 */
class EBTFSPurchaseReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    public $AllowDup;
    /**
     * Constructor method for EBTFSPurchaseReqBlock1Type
     * @uses EBTFSPurchaseReqBlock1Type::setAmt()
     * @uses EBTFSPurchaseReqBlock1Type::setCardData()
     * @uses EBTFSPurchaseReqBlock1Type::setPinBlock()
     * @uses EBTFSPurchaseReqBlock1Type::setCardHolderData()
     * @uses EBTFSPurchaseReqBlock1Type::setAllowDup()
     * @param float $amt
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\EBTFSPurchaseReqBlock1Type
     */
