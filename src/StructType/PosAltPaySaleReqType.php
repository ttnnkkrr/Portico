...
/**
 * This class stands for PosAltPaySaleReqType StructType
 * @subpackage Structs
 */
class PosAltPaySaleReqType extends AbstractStructBase
{
    /**
     * The TransactionType
    ...
    public $LineItem;
    /**
     * Constructor method for PosAltPaySaleReqType
     * @uses PosAltPaySaleReqType::setTransactionType()
     * @uses PosAltPaySaleReqType::setSessionId()
     * @uses PosAltPaySaleReqType::setBuyer()
     * @uses PosAltPaySaleReqType::setAmt()
     * @uses PosAltPaySaleReqType::setShipping()
     * @uses PosAltPaySaleReqType::setPayment()
     * @uses PosAltPaySaleReqType::setLineItem()
     ...
     * @param string $transactionType
     * @return \StructType\PosAltPaySaleReqType
     */
