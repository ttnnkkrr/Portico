...
/**
 * This class stands for GiftCardAddValueReqBlock1Type StructType
 * @subpackage Structs
 */
class GiftCardAddValueReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    public $Currency;
    /**
     * Constructor method for GiftCardAddValueReqBlock1Type
     * @uses GiftCardAddValueReqBlock1Type::setAmt()
     * @uses GiftCardAddValueReqBlock1Type::setCardData()
     * @uses GiftCardAddValueReqBlock1Type::setCurrency()
     * @param float $amt
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\GiftCardAddValueReqBlock1Type
     */
