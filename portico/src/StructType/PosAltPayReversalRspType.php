...
/**
 * This class stands for PosAltPayReversalRspType StructType
 * @subpackage Structs
 */
class PosAltPayReversalRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPayReversalRspType
     * @uses PosAltPayReversalRspType::setRspCode()
     * @uses PosAltPayReversalRspType::setRspMessage()
     * @uses PosAltPayReversalRspType::setStatus()
     * @uses PosAltPayReversalRspType::setStatusMessage()
     * @uses PosAltPayReversalRspType::setAmt()
     * @uses PosAltPayReversalRspType::setProcessor()
     * @param int $rspCode
     ...
     */
    public function __construct($rspCode = null, $rspMessage = null, $status = null, $statusMessage = null, $amt = null, \StructType\Processor $processor = null)
    {
        $this
            ->setRspCode($rspCode)
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPayReversalRspType
     */
