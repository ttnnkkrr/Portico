...
/**
 * This class stands for PosReportSearchRspType StructType
 * @subpackage Structs
 */
class PosReportSearchRspType extends AbstractStructBase
{
    /**
     * The Header
    ...
    public $Details;
    /**
     * Constructor method for PosReportSearchRspType
     * @uses PosReportSearchRspType::setHeader()
     * @uses PosReportSearchRspType::setDetails()
     ...
     * Set Header value
     * @param \StructType\Header $header
     * @return \StructType\PosReportSearchRspType
     */
    ...
    {
        foreach ($details as $posReportSearchRspTypeDetailsItem) {
            // validation for constraint: itemType
            if (!$posReportSearchRspTypeDetailsItem instanceof \StructType\Details) {
                throw new \InvalidArgumentException(sprintf('The Details property can only contain items of \StructType\Details, "%s" given', is_object($posReportSearchRspTypeDetailsItem) ? get_class($posReportSearchRspTypeDetailsItem) : gettype($posReportSearchRspTypeDetailsItem)), __LINE__);
            }
        }
