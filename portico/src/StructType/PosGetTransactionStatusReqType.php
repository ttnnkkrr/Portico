...
/**
 * This class stands for PosGetTransactionStatusReqType StructType
 * @subpackage Structs
 */
class PosGetTransactionStatusReqType extends AbstractStructBase
{
    /**
     * The GatewayTxnId
    ...
    public $ClientTxnId;
    /**
     * Constructor method for PosGetTransactionStatusReqType
     * @uses PosGetTransactionStatusReqType::setGatewayTxnId()
     * @uses PosGetTransactionStatusReqType::setClientTxnId()
     ...
     * @param int $gatewayTxnId
     * @return \StructType\PosGetTransactionStatusReqType
     */
