...
/**
 * This class stands for PosAltPayOrderRspType StructType
 * @subpackage Structs
 */
class PosAltPayOrderRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPayOrderRspType
     * @uses PosAltPayOrderRspType::setRspCode()
     * @uses PosAltPayOrderRspType::setRspMessage()
     * @uses PosAltPayOrderRspType::setStatus()
     * @uses PosAltPayOrderRspType::setStatusMessage()
     * @uses PosAltPayOrderRspType::setProcessor()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPayOrderRspType
     */
