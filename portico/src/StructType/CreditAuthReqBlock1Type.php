...
/**
 * This class stands for CreditAuthReqBlock1Type StructType
 * @subpackage Structs
 */
class CreditAuthReqBlock1Type extends AbstractStructBase
{
    /**
     * The Amt
    ...
    public $TagData;
    /**
     * Constructor method for CreditAuthReqBlock1Type
     * @uses CreditAuthReqBlock1Type::setAmt()
     * @uses CreditAuthReqBlock1Type::setGatewayTxnId()
     * @uses CreditAuthReqBlock1Type::setCardData()
     * @uses CreditAuthReqBlock1Type::setPaymentMethodKey()
     * @uses CreditAuthReqBlock1Type::setPaymentMethodKeyData()
     * @uses CreditAuthReqBlock1Type::setGratuityAmtInfo()
     * @uses CreditAuthReqBlock1Type::setCPCReq()
     * @uses CreditAuthReqBlock1Type::setCardHolderData()
     * @uses CreditAuthReqBlock1Type::setDirectMktData()
     * @uses CreditAuthReqBlock1Type::setAllowDup()
     * @uses CreditAuthReqBlock1Type::setLodgingData()
     * @uses CreditAuthReqBlock1Type::setAutoSubstantiation()
     * @uses CreditAuthReqBlock1Type::setAllowPartialAuth()
     * @uses CreditAuthReqBlock1Type::setEcommerce()
     * @uses CreditAuthReqBlock1Type::setAdditionalTxnFields()
     * @uses CreditAuthReqBlock1Type::setOrigTxnRefData()
     * @uses CreditAuthReqBlock1Type::setConvenienceAmtInfo()
     * @uses CreditAuthReqBlock1Type::setShippingAmtInfo()
     * @uses CreditAuthReqBlock1Type::setTxnDescriptor()
     * @uses CreditAuthReqBlock1Type::setSurchargeAmtInfo()
     * @uses CreditAuthReqBlock1Type::setEMVData()
     * @uses CreditAuthReqBlock1Type::setSecureECommerce()
     * @uses CreditAuthReqBlock1Type::setTagData()
     * @param float $amt
     ...
     * Set Amt value
     * @param float $amt
     * @return \StructType\CreditAuthReqBlock1Type
     */
