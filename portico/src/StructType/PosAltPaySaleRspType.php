...
/**
 * This class stands for PosAltPaySaleRspType StructType
 * @subpackage Structs
 */
class PosAltPaySaleRspType extends AbstractStructBase
{
    /**
     * The RspCode
    ...
    public $Processor;
    /**
     * Constructor method for PosAltPaySaleRspType
     * @uses PosAltPaySaleRspType::setRspCode()
     * @uses PosAltPaySaleRspType::setRspMessage()
     * @uses PosAltPaySaleRspType::setStatus()
     * @uses PosAltPaySaleRspType::setStatusMessage()
     * @uses PosAltPaySaleRspType::setProcessor()
     * @param int $rspCode
     ...
     * Set RspCode value
     * @param int $rspCode
     * @return \StructType\PosAltPaySaleRspType
     */
